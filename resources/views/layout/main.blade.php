...
<body data-sidebar="dark">
                ...
                <div class="dropdown d-inline-block h-100">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item text-danger" onclick="logout()"><i
                                class="bi bi-power font-size-16 align-middle mr-1 text-danger"></i> <span
    ...
    <script>
        ...
        // function simpan_profil(inputElement) {
        ...
        //     $.ajax({
        //         url: BASE_URL + 'pegawai/store_nip',
        //         method: "POST",
        //         data: {
        ...
        //         },
        //         success: function(response) {
        //             // Tampilkan notifikasi toastr berdasarkan pesan flash data yang diterima
        //             if (response.success) {
        ...
        //             toastr.error("Terjadi kesalahan saat mengirim permintaan.", "Error");
        //         }
        //     });
        // }
    </script>
