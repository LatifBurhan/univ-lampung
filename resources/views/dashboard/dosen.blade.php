        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header list-group-item list-group-item-action active">
                    Data Dosen
                    <div class="toolbar">
                        <button type="button" data-toggle="modal" data-target="#modal-popout" id="btn-tambah-dosen"
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <div class="btn-group" role="group">
                                                <button class="btn btn-warning" title="Details Dosen"
                                                    onclick="detailsButton({{ $row->id }})">
                                                    <i class="bx bxs-detail"></i>
                                                </button>
                                                <button class="btn btn-success" title="Reset Password"
                                                    onclick="resetPassword({{ $row->users->id }})">
                                                    <i class="bx bxs-key"></i>
                                                </button>
                                                <button class="btn btn-danger" title="Delete Data Dosen"
                                                    onclick="deleteData('{{ route('delete.dosen', ['id' => $row->id]) }}')">
        ...
        <div class="modal-dialog modal-dialog-popout modal-xl">
            <div class="modal-content">
                <div class="modal-header border">
                    ...
                    <button type="button" class="btn-close" style="bg-transparent" data-dismiss="modal"
                    ...
                    <div class="container ">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade active show" id="home" role="tabpanel"
                                ...
                                <form action="{{ route('dosen.profile') }}" method="post" id="form-profil"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="form_profile_dosen_id"
                                        value="{{ 'form_profile_dosen_id' }}">
                                    ...
                                    <div class="form-row mt-2">
                                        <div class="form-group col-md-6">
                                            <label for="">Tempat Tgl. Lahir <small class="text-danger">Tempat, dd mm
                                                    yyyy</small></label>
                                            <input type="text" name="ttl_dosen" id="ttl_dosen" class="form-control"
                                    ...
                                    <div class="form-row mt-2">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" name="email_dosen" id="email_dosen"
                                                class="form-control" placeholder="abc@xyz.com" required="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Website</label>
                                            <input type="text" name="website_dosen" id="website_dosen"
                                                class="form-control" placeholder="Website" required="">
                                        </div>
                                    </div>
                                    <div class="form-row mt-2">
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="judul_desertasi" id="judul_desertasi"
                                                class="form-control" placeholder="Judul Desertasi" required="">
                                        </div>
                                    </div>
                                    <div class="form-row mt-2">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" name="pas_foto" id="pas_foto" class="form-control"
                                                accept=".jpeg,.png,.gif,.jfif,.jpg" required="">
                                        </div>
                                    </div>

                                    <button type="submit" class="submit-form btn btn-primary mb-3"
                                        data-form="form-profil" data-route="{{ route('dosen.profile') }}"
                                        data-message="Data Profile Dosen berhasil disimpan">Simpan</button>
                                </form>
                            </div>
