    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header py-3">
                ...
                <div class="toolbar">
                    <button type="button" data-toggle="modal" data-target="#modal-popout" class="btn btn-success "><i
                            class="fa fa-download"></i> Import Data</button>
                    <button type="button" data-toggle="modal" onclick="_form()" class="btn btn-primary "><i
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="display table table-bordered dataTable no-footer" id="table_iku_one"
                        style="border-collapse: collapse; border-spacing: 0px; width: 0%;">
                ...
                <div class="modal-content">
                    <div id="content_modal">
                        ...
                        <div class="modal-body fw-bold">
                            ...
                            <a href="https://egov.phicos.co.id/tema/Skote_v2.1.0/HTML/Admin/dist/assets/excel/iku1.xlsx"
                                class="text-light bg-primary" style="padding: 10px; border-radius: 10px">Download Template
                                Excel</a>
                            <br>
                            <label for="input" class="mt-4">Upload File Import</label>
                            <input type="file" id="file" accept=".xlsx" name="file" class="form-control"
                                style="border: solid 1px rgba(114, 114, 114, 0.281);" required>
                            <label for="input" style="color: red; font-weight: 400">*Max 5Mb (xlsx)</label>
                            <br>
                            <h6 class="mt-2">Sub Klasifikasi</h6>
                            <select class="form-control col-12" id="klasifikasi" name="klasifikasi">
                                <option value="a" selected>Lulusan mendapatkan pekerjaan yang layak (masa tunggu &lt;6
                                    bulan)</option>
                                <option value="b">Lulusan yang Melanjutkan Studi</option>
                                <option value="c">Lulusan Berwirausaha</option>
                            </select>
